...
from flask import jsonify, request, send_from_directory, current_app, Blueprint
...
@appointment_bp.route("/appointments/<int:appt_id>/summary", methods=["GET"])
...
@appointment_bp.route("/appointments/<int:appt_id>/summary", methods=["POST"])
...
@appointment_bp.route("/appointments/<int:appt_id>/documents", methods=["POST"])
...
@appointment_bp.route("/uploads/<path:filename>")
